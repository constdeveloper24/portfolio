      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        <div>
          ...
          <div className="mb-[3rem] flex items-center md:space-x-10">
            <span className="w-[100px] hidden md:block h-[5px] bg-slate-400 reounded-sm"></span>
            <p className="text-[19px] text-slate-300 w-[80%]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe
              mollitia sunt sed ratione soluta, illo eum reiciendis architecto
              fugiat eos adipisci eveniet cum repellendus, perferendis dolore
              laboriosam molestiae magni itaque?
            </p>
          </div>
